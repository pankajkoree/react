...
// export {usersData, myName as mN}

// we can use both export method, it's not compulsory to use the same export way for both


// we can use named export at the time of declaring but can't export default using the same way

// actually we can do by declaring the variable above and then exporting  it as named export for default export

// also can directly export default but don't need to save in some vari